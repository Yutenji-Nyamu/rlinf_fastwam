#!/usr/bin/env bash
set -u
run_dir=/data/chenyiteng/results/rlinf-shenzhen/online-bc/pi0-adjust-bottle-smoke32x1-b1024-u10-eval8x4-gpu6-20260905-v8
...
timeout --signal=TERM --kill-after=180s 5400 "$venv/bin/python" -u \
  ...
  runner.logger.experiment_name=pi0-bc-u10-eval8x4-smoke-gpu6 > "$run_dir/driver.log" 2>&1 &
child=$!
