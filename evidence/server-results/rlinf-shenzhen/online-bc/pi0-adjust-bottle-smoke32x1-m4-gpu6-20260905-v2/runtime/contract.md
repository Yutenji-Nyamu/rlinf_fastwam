...
输出：`/data/chenyiteng/results/rlinf-shenzhen/online-bc/pi0-adjust-bottle-smoke32x1-m4-gpu6-20260905-v2`。存在则拒绝启动。wrapper独立PGID，连接既有Ray 6389，RLinf独立namespace，显式代码工作树和绝对输出路径；ASSETS_PATH指向RoboTwin仓库根，不是assets子目录；不设全局CUDA_VISIBLE_DEVICES重编号，不加载Fast原生shim。
