...
downloads = {
    f"{run}/tensorboard/events.out.tfevents.1785236070.autodl-container-nekaqbwt43-6ce5babb.70062.0":
        workspace / ".tmp" / "dsrl_step188_events.tfevents",
    f"{run}/resource_monitor/resources.csv":
        workspace / ".tmp" / "dsrl_step188_resources.csv",
    f"{run}/resource_monitor/cgroup_detail.csv":
        workspace / ".tmp" / "dsrl_step188_cgroup_detail.csv",
    f"{run}/resource_monitor/peak.txt":
        workspace / ".tmp" / "dsrl_step188_peak.txt",
    f"{run}/formal_driver.log":
        workspace / ".tmp" / "dsrl_step188_formal_driver.log",
    f"{run}/metrics.log":
        workspace / ".tmp" / "dsrl_step188_metrics.log",
}
