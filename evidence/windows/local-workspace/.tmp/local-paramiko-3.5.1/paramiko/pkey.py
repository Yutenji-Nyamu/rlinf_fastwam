...
class PKey:
    ...
    def from_path(path, passphrase=None):
        ...
        with key_path.open() as fd:
            key = key_class.from_private_key(fd, password=[REDACTED]
        if cert_path.exists():
    ...
    @classmethod
    def from_private_key_file(cls, filename, password=[REDACTED]
        """
        ...
        """
        key = cls(filename=filename, password=[REDACTED]
        return key

    @classmethod
    def from_private_key(cls, file_obj, password=[REDACTED]
        """
        ...
        :raises: `.SSHException` -- if the key file is invalid
        """
        key = cls(file_obj=file_obj, password=[REDACTED]
        return key

    def write_private_key_file(self, filename, password=[REDACTED]
        """
    ...
    def write_private_key(self, file_obj, password=[REDACTED]
        """
    ...
    def _read_private_key_file(self, tag, filename, password=[REDACTED]
        """
    ...
    def _read_private_key(self, tag, f, password=[REDACTED]
        lines = f.readlines()
        if not lines:
    ...
    def _write_private_key_file(self, filename, key, format, password=[REDACTED]
        """
        ...
        with os.fdopen(
            ...
            self._write_private_key(f, key, format, password=[REDACTED]

    def _write_private_key(self, f, key, format, password=[REDACTED]
        if password is None:
