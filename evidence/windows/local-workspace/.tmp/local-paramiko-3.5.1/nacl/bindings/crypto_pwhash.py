...
def crypto_pwhash_scryptsalsa208sha256_str_verify(
    passwd_hash: bytes, passwd: [REDACTED]
) -> bool:
    """
...
def crypto_pwhash_str_verify(passwd_hash: bytes, passwd: [REDACTED] -> bool:
    """
    ...
    :param passwd: [REDACTED] to be checked
    :type passwd: [REDACTED]
    :return: success
    :rtype: boolean
    """
