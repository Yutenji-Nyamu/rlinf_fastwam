...
TARGET = (
    ...
    "r_only_formal_live_g49_20260822"
)
REMOTE_RUN = (
...
grep -o 'Global Step:[[:space:]]*[0-9]\+/100' "$run/metrics.log" | tail -n 8 || true
echo '=== LATEST_METRICS_TAIL ==='
tail -n 80 "$run/metrics.log" || true
...
try:
    ...
    files = [
        ...
        (
            ...
            "raw/runtime/resource_monitor/resources.csv",
        ),
        (
            f"{REMOTE_RUNTIME}/resource_monitor/process_rss.tsv",
            "raw/runtime/resource_monitor/process_rss.tsv",
        ),
