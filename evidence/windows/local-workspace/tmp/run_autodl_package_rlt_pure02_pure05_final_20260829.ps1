...
try {
    ...
    $remote = '/root/autodl-tmp/experiment_exports/rlt_dvac_pure02_pure05_final480_high_info_20260829_v1.tar.gz'
    $local = 'tmp\rlt_dvac_pure02_pure05_final480_high_info_20260829_v1.tar.gz'

    & $python $helper run --command-file 'tmp\autodl_package_rlt_pure02_pure05_final_20260829.sh'
