...
run_dir=/root/autodl-tmp/idea2_dvac_train_runs/idea2_dvac_apply_smoke_2step_2gpu16env_20260820
runtime_dir=/root/autodl-tmp/idea2_dvac_train_runtime/idea2_dvac_apply_smoke_2step_2gpu16env_20260820
...
printf '%s\n' \
  "$python_bin $source_root/examples/embodiment/train_embodied_agent.py --config-path $source_root/examples/embodiment/config/ --config-name robotwin_adjust_bottle_grpo_openpi_dvac_train_2step_smoke" \
