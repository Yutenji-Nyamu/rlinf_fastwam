...
printf '%s\n' \
  "$python_bin $source_root/examples/embodiment/train_embodied_agent.py --config-path $source_root/examples/embodiment/config/ --config-name robotwin_adjust_bottle_grpo_openpi_dvac_r_only_downweight_2step_smoke" \
