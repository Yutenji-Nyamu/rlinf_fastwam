...
DEST = WORKSPACE / "docs" / "rlinf-robotwin-pi0-dvac-telemetry" / "evidence" / "v3_formal_live_g36_20260823" / "raw"
...
FILES = [
    ...
    (f"{REMOTE_RUN}/dvac_train/actor_rank00/rollout_step0035.npz", "run/dvac_train/actor_rank00/rollout_step0035.npz"),
    (f"{REMOTE_RUN}/dvac_train/actor_rank01/rollout_step0035.npz", "run/dvac_train/actor_rank01/rollout_step0035.npz"),
...
GROWING_FILES = {"runtime/resource_monitor/resources.csv"}
    ...
    try:
        with client.open_sftp() as sftp:
            ...
            for attrs in sftp.listdir_attr(event_dir):
                if attrs.filename.startswith("events.out.tfevents"):
