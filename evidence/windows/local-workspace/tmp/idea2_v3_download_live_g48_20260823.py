...
DEST = WORKSPACE / "docs" / "rlinf-robotwin-pi0-dvac-telemetry" / "evidence" / "v3_formal_live_g48_20260823" / "raw"
...
FILES = [
    ...
    (f"{REMOTE_RUN}/dvac_train/actor_rank00/rollout_step0047.npz", "run/dvac_train/actor_rank00/rollout_step0047.npz"),
    (f"{REMOTE_RUN}/dvac_train/actor_rank01/rollout_step0047.npz", "run/dvac_train/actor_rank01/rollout_step0047.npz"),
