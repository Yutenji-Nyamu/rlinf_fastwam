...
checkpoints = list(range(10, steps[-1] + 1, 10))
...
root_id = f"fastwamMoveStaplerStep{steps[-1]}"
html = f'''<div id="{root_id}">
  <div class="viz-grid">
...
<style>
  ...
  #{root_id} section {{ min-width:0; }}
  #{root_id} h3 {{ margin:0 0 6px; }}
  #{root_id} .fw-chart {{ position:relative; width:100%; min-width:0; height:260px; }}
  @media (max-width:480px) {{ #{root_id} .fw-chart {{ height:230px; }} }}
</style>
