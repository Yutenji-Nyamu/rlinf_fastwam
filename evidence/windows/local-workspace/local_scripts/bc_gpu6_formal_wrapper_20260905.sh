#!/usr/bin/env bash
set -u
run_dir=/data/chenyiteng/results/rlinf-shenzhen/online-bc/pi0-adjust-bottle-online-bc32x1-m4-gpu6-formal100-20260905-v1
...
timeout --signal=TERM --kill-after=180s 172800s "$venv/bin/python" -u \
