"""Render the current Action-Adv/ST-DVAC pair with distinct colors."""
...
renderer.OUT = OUT
renderer.TITLE = "SZ-H100 current matched two-GPU GRPO pair"
renderer.SUBTITLE = "Same 64 env x 4 rollout epochs, G8 and B1024; each line stops at its latest complete step."
renderer.RUNS = {
    "action_mid": {
