...
CONTROL=grpo-control-formal100-2gpu64x4-b1024-eval5-phys45-v1
DVAC=dvac-global-z-w0to2-formal100-2gpu64x4-b1024-eval5-phys67-v1
...
start_one() {
  ...
  printf '%s\n' \
    ...
    'eval=fixed64 as 64 env x 1 wave every5; checkpoint every10' \
...
start_one "$CONTROL" '4,5' robotwin_grpo_control_2gpu64x4_b1024_eval5 off
...
start_one "$DVAC" '6,7' robotwin_grpo_dvac_global_z_w0to2_2gpu64x4_b1024_eval5 apply
...
echo SZ_DUAL_GRPO_2GPU_FORMAL100_LAUNCHED
