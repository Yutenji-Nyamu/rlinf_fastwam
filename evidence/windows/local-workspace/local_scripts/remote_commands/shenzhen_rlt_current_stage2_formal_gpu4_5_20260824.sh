...
run_root=/data/chenyiteng/results/rlinf-rlt/formal-current-ar-stage2-8env250-20260824-v3
runtime=$run_root/runtime
experiment=robotwin_adjust_bottle_rlt_stage2_current_ar_8env250_output_isolated_v2
...
printf '%s\n' \
  ...
  'save=every25 cycles; expected 10 checkpoints' \
...
printf '%s\n' 'SZ_RLT_CURRENT_STAGE2_FORMAL_LAUNCHED'
