...
compose "$CONTROL" '4,5' robotwin_grpo_control_2gpu64x4_b1024_eval5 off
compose "$DVAC" '6,7' robotwin_grpo_dvac_global_z_w0to2_2gpu64x4_b1024_eval5 apply
...
payload = {
    ...
    "eval": "fixed64 as 64 env x 1 wave every 5 steps",
...
echo SZ_DUAL_GRPO_2GPU_FORMAL100_PREPARED
