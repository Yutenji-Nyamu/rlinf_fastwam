...
printf '%s\n' \
  ...
  'physical_gpus=4,5' \
  'shared_ray_address=172.17.0.1:6389' \
  ...
  "stage2_train_output=$stage2/robotwin_data/train" \
  "stage2_eval_output=$stage2/robotwin_data/eval" \
...
nohup setsid bash -c '
  ...
  stage2_args=(
    ...
    "env.train.video_cfg.video_base_dir=$stage2/video/train"
    "env.train.task_config.save_path=$stage2/robotwin_data/train"
    env.eval.video_cfg.save_video=false
    "env.eval.video_cfg.video_base_dir=$stage2/video/eval"
    "env.eval.task_config.save_path=$stage2/robotwin_data/eval"
  )
