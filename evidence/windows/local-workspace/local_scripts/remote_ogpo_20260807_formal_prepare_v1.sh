...
evidence_root=/root/autodl-tmp/experiment_exports/ogpo_robotwin_formal_20260807_v1
...
# Run identity plus exactly the four user-approved budget semantics. Paired UTD
# maps to two code fields because actor and critic have separate schedulers.
overrides=(
...

{
  ...
  printf 'wall_time_estimate_hours\t19-21\n'
