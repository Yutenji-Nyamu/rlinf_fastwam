...
def main(cfg: DictConfig):
    ...
    _append_override(
        overrides,
        "dvac_telemetry_enabled",
        cfg.EVALUATION.dvac_telemetry.enabled,
    )
    _append_override(
        overrides,
        "dvac_telemetry_output_dir",
        cfg.EVALUATION.dvac_telemetry.output_dir,
    )
    _append_override(
        overrides,
        "dvac_telemetry_run_id",
        cfg.EVALUATION.dvac_telemetry.run_id,
    )
    _append_override(
        overrides,
