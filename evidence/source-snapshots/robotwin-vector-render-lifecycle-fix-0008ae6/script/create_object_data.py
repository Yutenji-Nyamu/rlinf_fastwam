...
class BaseViewer:
    ...
    def add_visual_box(self, pose: sapien.Pose, name: str = "box", type: str = "cube"):
        ...
        if assets_path:
            modelpath = Path(assets_path) / "assets/objects/vis_box" / modelname
...
class ObjectViewer(BaseViewer):
    ...
    def load_actor(self, pose, inherit_config=None, inherit_type: Literal['force', 'advice'] = 'advice'):
        ...
        assets_path = os.getenv("ASSETS_PATH")
        if assets_path:
            modeldir = Path(assets_path) / "assets/objects" / self.modelname
...
class URDFViewer(BaseViewer):
    ...
    def load_actor(self, pose, inherit_config=None, inherit_type: Literal['force', 'advice'] = 'advice'):
        ...
        assets_path = os.getenv("ASSETS_PATH")
        if assets_path:
            modeldir = Path(assets_path) / "assets/objects" / self.modelname / str(self.modelid)
...
def auto_loader(model_name: str):
    ...
    assets_path = os.getenv("ASSETS_PATH")
    if assets_path:
        model_dir = Path(assets_path) / "assets/objects" / model_name
