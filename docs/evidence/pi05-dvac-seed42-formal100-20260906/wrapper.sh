#!/usr/bin/env bash
set -u
run_dir=/data/chenyiteng/results/rlinf-shenzhen/online-bc/pi05-pillbottle-bc-dvac32x1-b1024-u10-m10-seed42-w0to2-eval8x4-gpu7-formal100-20260906-v2
...
timeout --signal=TERM --kill-after=180s 172800 "$venv/bin/python" -u \
  ...
  runner.logger.experiment_name=pi05-pillbottle-bc-dvac-seed42-w0to2-u10-formal100-gpu7 \
