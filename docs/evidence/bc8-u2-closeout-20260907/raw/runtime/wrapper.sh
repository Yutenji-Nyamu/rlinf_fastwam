#!/usr/bin/env bash
set -u
run_dir=/data/chenyiteng/results/rlinf-shenzhen/online-bc/pi05-pillbottle-bc8x1-b1024-u2-m10-seed42-eval8x4-gpu6-formal100-20260907-v1
...
timeout --signal=TERM --kill-after=180s 172800 "$venv/bin/python" -u \
  ...
  runner.logger.experiment_name=pi05-pillbottle-bc-seed42-8x1-u2-formal100-gpu6-0907 \
