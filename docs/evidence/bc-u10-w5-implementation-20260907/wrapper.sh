#!/usr/bin/env bash
set -u
run_dir=/home/chenyiteng/results/rlinf-shenzhen/online-bc/pi05-pillbottle-bc8x1-b1024-u10-m10-seed42-eval8x4-gpu6-formal100-20260907-v2
root=/data/chenyiteng/projects/rlinf-shenzhen/worktrees/pi05-online-bc-u10
...
timeout --signal=TERM --kill-after=180s 172800 "$venv/bin/python" -u \
  ...
  runner.logger.experiment_name=pi05-pillbottle-bc-seed42-8x1-u10-formal100-gpu6-0907-v2 \
