...
class DVACTelemetryWriter:
    ...
    def append(
        ...
        *,
        ...
        final_model_action = _to_numpy(
            telemetry["final_model_action"], float32=True
        )
        ...
        if self.save_query_inputs:
            ...
            if main_images.shape[0] != batch_size or wrist_images.shape[0] != batch_size:
                raise ValueError("Query images must be aligned with the telemetry batch.")
    ...
    def finalize(self) -> dict[str, str]:
        ...
        if existing_paths:
            ...
            raise FileExistsError(f"Refusing to overwrite DVAC shard artifacts: {joined}")
