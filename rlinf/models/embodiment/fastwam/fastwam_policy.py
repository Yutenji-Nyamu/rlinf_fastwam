...
from .online_bc import FastWAMOnlineBCMixin
...
class FastWAMPolicy(FastWAMOnlineBCMixin, nn.Module, BasePolicy):
    ...
    def predict_action_batch(
        ...
        **kwargs,
        ...
        if kwargs.get("online_bc", False):
            return self.predict_online_bc_action_batch(env_obs, mode=mode)
