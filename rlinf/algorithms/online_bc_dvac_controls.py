...
"""Online BC controls adapted from the GRPO DVAC controls.
...
def bc_controls_contract(cfg: dict) -> dict:
    ...
    if contract and (
        ...
        or cfg.get("normalization") != "two_level_batch"
    ):
        raise ValueError(
            "BC DVAC controls require active two_level_batch and "
...
def effective_alphas(
    ...
    *,
    ...
    ``controls`` must be the result of :func:`bc_controls_contract`.
    """
