...
ST=Path('/data/chenyiteng/deployment-20260920/fastwam-rlt-t25-combo')
...
def pipeline():
 ...
 q=launch('combo');save(ST/'formal-dispatched.json',{'time':now(),'driver':proc(q.pid)});wait_child('combo',q)
