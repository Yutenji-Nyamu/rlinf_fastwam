...
def make_formal():
 ...
 with initialize_config_dir(config_dir=str(Path(p['repo'])/'examples/embodiment/config'),version_base=None):cfg=compose(config_name='robotwin_adjust_bottle_fastwam_rlt_clean4_800_20260919');OmegaConf.resolve(cfg)
