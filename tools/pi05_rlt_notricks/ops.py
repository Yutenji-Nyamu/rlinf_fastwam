...
ST=Path('/data/chenyiteng/deployment-20260920/pi05-rlt-notricks-t2-t25')
...
def pipeline():
 ...
 qs={k:launch(k) for k in ('t2','t25')};save(ST/'formal-dispatched.json',{'time':now(),'drivers':{k:proc(q.pid) for k,q in qs.items()}})
